...
struct Config {
    ...
    float tableHudWidth = 1.5f;         // width of the HUD lying on the table (metres)
    bool tableWheelAtLink = true;       // the item wheel appears around Link in the diorama
    float tableWheelWidth = 1.0f;       // width of the HUD panel while the item wheel is open (metres)
