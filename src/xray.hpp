...
struct EyeParams {
    ...
    float radiusAlphaTested; // full radius: alpha-tested materials (foliage) and anything above Link's head
    ...
    float body;              // nothing this close to Link's body (feet to head) is cut
