...
adb shell "am start -n $pkg/dev.twilitrealm.dusk.DuskActivity --es dusk_args '--dvd /storage/emulated/0/Download/tp-linkle.iso --mods /storage/emulated/0/Download/dusk-mods --stage ${STAGE:-F_SP103} $*'" >/dev/null
